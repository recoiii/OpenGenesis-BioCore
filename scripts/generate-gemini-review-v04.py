#!/usr/bin/env python3
"""Generate deterministic, size-bounded four-part Markdown review packages for v0.4."""
...
BASELINE_NAME = "accepted/iteration-077"
BASELINE_COMMIT = "d0dc0e41da7c55e128a718020a1d03da0687662e"
PART_COUNT = 4
...
def common_header(
    ...
    release_identity = "0.4.0" if iteration >= 78 else "0.4.0-dev"
    ci_lines = ""
